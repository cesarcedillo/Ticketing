...
public class TicketRepositoryTests
{
  ...
  public TicketRepositoryTests()
  {
    ...
    var ticket1 = new TicketType("Cannot log in", "I always get an error when trying to log in.", user1);
    var ticket2 = new TicketType("Question about billing", "How can I get my invoice?", user1);
