...
using Ticketing.Notifications.API.Infrastructure;
using Ticketing.Notifications.Application;
...
public static class MinimalApiExtensions
{
  public static void RegisterServices(this WebApplicationBuilder builder)
  {
    ...
    Notifications.Infrastructure.DependencyInjection.AddInfrastructureServices(builder.Services, Configuration, Environment.IsDevelopment());
